...
{% include carousel.html height="40" unit="%" duration="3" images="./assets/images/main_carousel/0.PNG,./assets/images/main_carousel/1.PNG,./assets/images/main_carousel/2.PNG,./assets/images/main_carousel/3.PNG,./assets/images/main_carousel/4.PNG,./assets/images/main_carousel/5.PNG,./assets/images/main_carousel/6.PNG,./assets/images/main_carousel/7.PNG"%}
